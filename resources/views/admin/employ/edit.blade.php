                        ...
                        <div class="card-body">
                            ...
                            <div class="row d-flex justify-content-center">
                                <div class="col-lg-8">
                                    ...
                                    <form action="{{route('employ.update',$employee->id)}}" method="POST"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="simpleinput"
                                                ...
                                                name="employee_code" value="{{$employee->employee_code}}" placeholder="Employ Code">
                                            @error('employee_code')
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="simpleinput"
                                                ...
                                                name="sur_name" placeholder="surname" value="{{$employee->sur_name}}">
                                            @error('sur_name')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="date" id="simpleinput"
                                                ...
                                                name="bd_date" placeholder="date of birth" value="{{$employee->bd_date}}">
                                            @error('bd_date')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="simpleinput"
                                                ...
                                                name="father_name" placeholder="father name" value="{{$employee->father_name}}">
                                            @error('father_name')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="simpleinput"
                                                ...
                                                name="mother_name" placeholder="mother name" value="{{$employee->mother_name}}">
                                            @error('mother_name')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="simpleinput"
                                                ...
                                                name="nationality" placeholder="nationality" value="{{$employee->nationality}}">
                                            @error('nationality')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="simpleinput"
                                                ...
                                                name="position" placeholder="position" value="{{$employee->position}}">
                                            @error('position')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="simpleinput"
                                                ...
                                                name="em_contact" placeholder="Emergency Contact no" value="{{$employee->em_contact}}">
                                            @error('em_contact')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="simpleinput"
                                                ...
                                                name="company_name" placeholder="Company Name" value="{{$employee->company_name}}">
                                            @error('company_name')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="simpleinput"
                                                ...
                                                name="contact_type" placeholder="Type of Contract" value="{{$employee->contact_type}}">
                                            @error('contact_type')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="simpleinput"
                                                ...
                                                name="salary" placeholder="Salary" value="{{$employee->salary}}">
                                            @error('salary')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="simpleinput"
                                                ...
                                                name="work_hour" placeholder="working Hours" value="{{$employee->work_hour}}">
                                            @error('work_hour')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="date" id="simpleinput"
                                                ...
                                                name="pp_issue_date" placeholder="Passport Issue Date" value="{{$employee->pp_issue_date}}">
                                            ...
                                            <input type="date" id="simpleinput"
                                                ...
                                                name="pp_expiry_date" placeholder="Passport expiry Date" value="{{$employee->pp_expiry_date}}">
                                            ...
                                            <input type="text" id="simpleinput"
                                                ...
                                                name="passport_no" placeholder="Passport Number" value="{{$employee->passport_no}}">
                                            @error('passport_no')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                            ...
                                            <input type="file" id="simpleinput"
                                                ...
                                                name="passport_file" placeholder="Passport Number" value="{{$employee->passport_file}}">
                                            @error('passport_file')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror

                                            <label for="simpleinput" class="form-label">New Passport Attachment
                                                file</label>
                                            <input type="file" id="simpleinput"
                                                class="form-control @error('update_passport_file') is-invalid @enderror"
                                                name="update_passport_file" placeholder="Passport Number" value="{{$employee->update_passport_file}}">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="date" id="simpleinput"
                                                ...
                                                name="rd_issue_date" value="{{$employee->rd_issue_date}}">
                                            ...
                                            <input type="date" id="simpleinput"
                                                ...
                                                name="rd_expiry_date" value="{{$employee->rd_expiry_date}}">
                                            ...
                                            <input type="file" id="simpleinput"
                                                ...
                                                name="rd_file" value="{{$employee->rd_file}}">
                                            @error('rd_file')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="file" id="simpleinput"
                                                ...
                                                name="d_residence_file" value="{{$employee->d_residence_file}}">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="date" id="simpleinput"
                                                ...
                                                name="work_issue_date" value="{{$employee->work_issue_date}}">
                                            ...
                                            <input type="date" id="simpleinput"
                                                ...
                                                name="work_expiry_date" value="{{$employee->work_expiry_date}}">
                                            ...
                                            <input type="file" id="simpleinput"
                                                ...
                                                name="work_file" value="{{$employee->work_file}}">
                                            @error('work_file')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="date" id="simpleinput"
                                                ...
                                                name="zus_date" value="{{$employee->zus_date}}">
                                            @error('zus_date')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                            <input type="file" id="simpleinput"
                                                class="form-control @error('zus_dec') is-invalid @enderror"
                                                name="zus_dec" value="{{$employee->zus_dec}}">
                                            @error('zus_dec')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                        ...
                                        <div class="mb-3">
                                            <label for="simpleinput" class="form-label">Work Contact Issue
                                                Date.</label>
                                            <input type="date" id="simpleinput"
                                                class="form-control @error('work_contact_issue_date') is-invalid @enderror mb-3"
                                                name="work_contact_issue_date" value="{{$employee->work_contact_issue_date}}">
                                            @error('work_contact_issue_date')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                            <label for="simpleinput" class="form-label">Work Contact Expiry
                                                Date.</label>
                                            <input type="date" id="simpleinput"
                                                class="form-control @error('work_contact_expiry_date') is-invalid @enderror mb-3"
                                                name="work_contact_expiry_date" value="{{$employee->work_contact_expiry_date}}">
                                            @error('work_contact_expiry_date')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                            <label for="simpleinput" class="form-label">Work Contact Attachment
                                                file</label>
                                            <input type="file" id="simpleinput"
                                                class="form-control @error('work_contact_file') is-invalid @enderror"
                                                name="work_contact_file" value="{{$employee->work_contact_file}}"> 
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="file" id="simpleinput"
                                                ...
                                                name="health_doc" value="{{$employee->health_doc}}">
                                            @error('health_doc')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="file" id="simpleinput"
                                                ...
                                                name="attachment1" value="{{$employee->attachment1}}">
                                            @error('attachment1')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="file" id="simpleinput"
                                                ...
                                                name="attachment2" value="{{$employee->attachment2}}">
                                            @error('attachment2')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="file" id="simpleinput"
                                                ...
                                                name="attachment3" value="{{$employee->attachment3}}">
                                            @error('attachment13')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="file" id="simpleinput"
                                                ...
                                                name="attachment4" value="{{$employee->attachment4}}">
                                            @error('attachment4')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="file" id="simpleinput"
                                                ...
                                                name="attachment5" value="{{$employee->attachment5}}">
                                            @error('attachment5')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="file" id="simpleinput"
                                                ...
                                                name="attachment6" value="{{$employee->attachment6}}">
                                            @error('attachment6')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="file" id="simpleinput"
                                                ...
                                                name="attachment7" value="{{$employee->attachment7}}">
                                            @error('attachment7')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="file" id="simpleinput"
                                                ...
                                                name="attachment8" value="{{$employee->attachment8}}">
                                            @error('attachment8')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="file" id="simpleinput"
                                                ...
                                                name="attachment9" value="{{$employee->attachment9}}">
                                            @error('attachment9')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="file" id="simpleinput"
                                                ...
                                                name="attachment10" value="{{$employee->attachment10}}">
                                            @error('attachment10')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="file" id="simpleinput"
                                                ...
                                                name="pasel_no" value="{{$employee->pasel_no}}">
                                            @error('pasel_no')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                        ...
                                        <div class="mb-3">
                                         ...
                                         <option value="{{$brance->id}}" {{$brance->id == $employee->new_shop_id ? 'selected' : ''}}>{{$brance->name}}</option>
                                         @endforeach
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select
                                                ...
                                                <option value="{{$brance->id}}"{{$brance->id == $employee->new_location_id ? 'selected' : ''}}>{{$brance->location}}</option>
                                              @endforeach
                                            </select>
                                            @error('shop_location_id')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="simpleinput"
                                                ...
                                                placeholder="accommodation address" name="accommodation_address" value="{{$employee->accommodation_address}}">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="simpleinput"
                                                ...
                                                placeholder="Previous Company Name" name="pre_company_name"  value="{{$employee->pre_company_name}}">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="file" id="simpleinput"
                                                ...
                                                name="exp_details" value="{{$employee->exp_details}}">
                                            @error('exp_details')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="simpleinput"
                                                ...
                                                placeholder="Contact No" name="contact_no" value="{{$employee->contact_no}}">
                                            @error('contact_no')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="simpleinput"
                                                ...
                                                name="reference" placeholder="Reference" value="{{$employee->reference}}">
                                            @error('reference')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select @error('marital_status') is-invalid @enderror"
                                                ...
                                                <option value="Merride" >Merride</option>
                                                <option value="Unmerride" >Unmerride</option>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="file" id="simpleinput" name="image"
                                                class="form-control @error('image') is-invalid @enderror" value="{{$employee->image}}">
                                            @error('image')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
