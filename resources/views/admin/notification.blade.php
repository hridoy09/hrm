                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row d-flex justify-content-center">
                                <div class="col-lg-12">
                                    <a class="text-dark btn btn-md btn-primary m-2 ms-0"
                                        ...
                                        <thead>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td> <a class="dropdown-item notify-item active py-1 "@if ($notification->read_at == null) href="{{route('notify.view', $notification->id)}}" @else href="#"@endif>
