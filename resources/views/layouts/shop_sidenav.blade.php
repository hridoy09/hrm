     ...
     <div class="left-side-menu">
        ...
        <div class="h-100" data-simplebar>
            ...
            <div class="user-box text-center">
                ...
                <img src="{{asset('')}}assets/images/users/dk.png" alt="user-img" title="Mat Helme" width="40%"  class="rounded-circle img-thumbnail avatar-md">
                    <div class="dropdown">
                        <a href="#" class="user-name dropdown-toggle h5 mt-2 mb-1 d-block" data-bs-toggle="dropdown"  aria-expanded="false">{{auth('shop')->user()->name}}</a>
                        <div class="dropdown-menu user-pro-dropdown">
                            ...
                            <a class="dropdown-item" href="{{ route('logout.shop') }}"
                            onclick="event.preventDefault();
                                          document.getElementById('logout-form').submit();">
                             {{ __('Logout') }}
                         </a>

                         <form id="logout-form" action="{{ route('logout.shop') }}" method="POST" class="d-none">
                             @csrf
                         </form>
            ...
            <div id="sidebar-menu">
                ...
                <ul id="side-menu">
                    ...
                    <li>
                        <a href="{{route('employ.list_by_shop')}}">
